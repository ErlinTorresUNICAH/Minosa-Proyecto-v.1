...
-- ================ MATERIAL ===================
-- =============================================
-- Procedimiento para Crear Material en la Tabla Materiales
-- Inserta un nuevo material en la tabla Materiales
CREATE PROCEDURE P_GRUD_CrearMaterial
    @Descripcion NVARCHAR(255),  -- Descripción del material
    @Cantidad INT,               -- Cantidad del material
    @id_area INT                 -- ID del área asociada al material
AS
BEGIN
    -- Insertar nuevo material en la tabla Materiales
    INSERT INTO Materiales (Descripcion, Cantidad, id_area) 
    VALUES (@Descripcion, @Cantidad, @id_area)
END
GO  

-- Procedimiento para Obtener Material por ID
-- Recupera un material específico y su área asociada
CREATE PROCEDURE P_GRUD_ObtenerMaterialPorID
    @ID_Material INT  -- ID del material a buscar
AS
BEGIN
    -- Obtener datos del material en la tabla Materiales
    SELECT 
...
-- Procedimiento para Actualizar Material
-- Actualiza los detalles de un material existente en la tabla Materiales
CREATE PROCEDURE P_GRUD_ActualizarMaterial
    @ID_Material INT,            -- ID del material a actualizar
    @Descripcion NVARCHAR(255),  -- Nueva descripción del material
    @Cantidad INT,               -- Nueva cantidad del material
    @id_area INT                 -- Nuevo ID del área asociada
AS
BEGIN
    -- Actualizar datos del material en la tabla Materiales
    UPDATE Materiales
...
-- Elimina un material específico de la tabla Materiales
CREATE PROCEDURE P_GRUD_EliminarMaterial
    @ID_Material INT  -- ID del material a eliminar
AS
BEGIN
    -- Eliminar material de la tabla Materiales
...
GO
CREATE PROCEDURE P_GRUD_ObtenerDireccionesIp
AS
BEGIN
    SELECT 
        DireccionesIp.ID_ip, 
...
END
GO
CREATE PROCEDURE P_GRUD_CrearDireccionIp
    @IPV4 NVARCHAR(255),
    @Estado NVARCHAR(255),
    @id_vlan INT
AS
BEGIN
    INSERT INTO DireccionesIp (IPV4, Estado, id_vlan, Activa) 
    VALUES (@IPV4, @Estado, @id_vlan, 1)  -- Activa se asigna como 1 (true) por defecto
END
GO
...
END
GO
CREATE PROCEDURE P_GRUD_EliminarDireccionIp
    @ID_ip INT
AS
BEGIN
...
-- ================== Vlan =====================
-- =============================================
CREATE PROCEDURE P_GRUD_EliminarVlan
    @ID_vlan INT
AS
BEGIN
...
CREATE PROCEDURE P_AllActualizarDetallesEquipoYProveedor
    @ID_equipo INT,
...
CREATE PROCEDURE P_AllObtenerDetallesEquipoPorID
    @ID_equipo INT
AS
BEGIN
...
CREATE PROCEDURE P_GRUD_EliminarMarca
    @ID_Marca INT
AS
BEGIN
...
GO
Create PROCEDURE P_GRUD_ActualizarMarca
    @ID_Marca INT,
    @Marca NVARCHAR(255),
    @Activa BIT
AS
