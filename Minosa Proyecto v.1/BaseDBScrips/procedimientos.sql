...
CREATE PROCEDURE [dbo].[P_GRUD_ActualizarProveedor]
...
CREATE PROCEDURE [dbo].[P_GRUD_ObtenerRadioPorID]
...
-- Eliminar proveedor
CREATE PROCEDURE P_GRUD_EliminarProveedor
    @ID_proveedor INT
AS
BEGIN
    UPDATE Proveedores SET Activo = 0 WHERE ID_proveedor = @ID_proveedor;
END;
...
CREATE PROCEDURE [dbo].[P_GRUD_ObtenerProveedorPorID]
...
CREATE PROCEDURE P_GRUD_EliminarRadio
    @ID_Radio INT
AS
BEGIN
...
CREATE PROCEDURE [dbo].[P_EliminarEquipoYDependencias]
...
CREATE PROCEDURE [dbo].[P_ObtenerRadiosConDetalles]
...
CREATE PROCEDURE [dbo].[P_ActualizarEquipo]
...
CREATE PROCEDURE [dbo].[P_ActualizarEquipoDetalle]
...
CREATE PROCEDURE [dbo].[P_ObtenerEquipoDetalle]
...
CREATE PROCEDURE [dbo].[P_EliminarEquipoCompleto]
...
CREATE PROCEDURE [dbo].[P_InsertarRadio]
...
CREATE PROCEDURE [dbo].[P_GRUD_ObtenerRadios]
...
CREATE PROCEDURE [dbo].[P_GRUD_ObtenerTiposEquipos]
...
CREATE PROCEDURE [dbo].[P_GRUD_CrearTipoEquipo]
...
CREATE PROCEDURE [dbo].[P_GRUD_ActualizarTipoEquipo]
...
CREATE PROCEDURE P_GRUD_EliminarTipoEquipo 
    @ID_TipoEquipo INT
AS
BEGIN
...
CREATE PROCEDURE [dbo].[P_GRUD_ObtenerTipoEquipoPorID]
...
CREATE PROCEDURE [dbo].[P_GRUD_ObtenerMarcas]
...
CREATE PROCEDURE [dbo].[P_GRUD_CrearMarca]
...
CREATE PROCEDURE [dbo].[P_GRUD_ObtenerModelos]
...
CREATE PROCEDURE [dbo].[P_GRUD_CrearModelo]
...
CREATE PROCEDURE [dbo].[P_GRUD_ObtenerModeloPorID]
...
CREATE PROCEDURE [dbo].[P_ObtenerUsuarioPorNombreYContrasena]
...
CREATE PROCEDURE [dbo].[P_ObtenerDatosEquipos]
...
CREATE PROCEDURE [dbo].[P_ObtenerUsuarioPorID]
...
CREATE PROCEDURE [dbo].[P_ActualizarUsuario]
...
CREATE PROCEDURE [dbo].[P_GRUD_ActualizarModelo]
...
CREATE PROCEDURE [dbo].[ObtenerDetallesEquipoPorID]
...
CREATE PROCEDURE [dbo].[P_EliminarModeloCompleto]
...
CREATE PROCEDURE [dbo].[P_GRUD_EliminarModelo]
...
CREATE PROCEDURE [dbo].[P_GRUD_ObtenerMarcaPorID]
...
CREATE PROCEDURE [dbo].[P_GRUD_ObtenerAreas]
...
CREATE PROCEDURE [dbo].[P_GRUD_CrearArea]
...
CREATE PROCEDURE [dbo].[P_GRUD_ObtenerAreaPorID]
...
CREATE PROCEDURE [dbo].[P_GRUD_ActualizarArea]
...
CREATE PROCEDURE [dbo].[P_GRUD_EliminarArea]
...
CREATE PROCEDURE [dbo].[P_GRUD_ObtenerZonas]
...
CREATE PROCEDURE [dbo].[P_GRUD_CrearZona]
...
CREATE PROCEDURE [dbo].[P_GRUD_ObtenerZonaPorID]
...
CREATE PROCEDURE [dbo].[P_GRUD_ActualizarZona]
...
CREATE PROCEDURE [dbo].[P_GRUD_EliminarZona]
...
CREATE PROCEDURE [dbo].[P_GRUD_ObtenerMateriales]
...
CREATE PROCEDURE [dbo].[P_ObtenerSoloRadios]
-- Obtener solo Radios
...
CREATE PROCEDURE [dbo].[P_GRUD_CrearMaterial]
...
CREATE PROCEDURE [dbo].[P_GRUD_ObtenerMaterialPorID]
...
CREATE PROCEDURE [dbo].[P_GRUD_ActualizarMaterial]
...
CREATE PROCEDURE P_GRUD_EliminarMaterial
    @ID_Material INT
AS
BEGIN
...
CREATE PROCEDURE [dbo].[P_GRUD_ObtenerDireccionIpPorID]
...
CREATE PROCEDURE [dbo].[P_GRUD_ActualizarVlan]
...
CREATE PROCEDURE [dbo].[P_GRUD_ActualizarDireccionIp]
...
CREATE PROCEDURE [dbo].[P_GRUD_ObtenerVlans]
...
CREATE PROCEDURE [dbo].[P_GRUD_CrearVlan]
...
CREATE PROCEDURE [dbo].[P_GRUD_ObtenerVlanPorID]
...
CREATE PROCEDURE [dbo].[P_InsertarEquipoYRadio]
...
CREATE PROCEDURE [dbo].[P_ObtenerProveedores]
...
CREATE PROCEDURE [dbo].[P_CRUD_EliminarRadio]
--select * from Radio
...
CREATE PROCEDURE [dbo].[P_ObtenerModelos]
...
CREATE PROCEDURE [dbo].[P_GRUD_CrearVlanID]
...
CREATE PROCEDURE [dbo].[P_ObtenerTiposEquipos]
...
CREATE PROCEDURE [dbo].[P_ObtenerAreas]
...
CREATE PROCEDURE [dbo].[P_ObtenerIPs]
...
CREATE PROCEDURE P_ObtenerActividad
AS
BEGIN
SELECT
    e.ID_equipo,
...
CREATE PROCEDURE [dbo].[P_InsertarEquipoCompleto]
...
CREATE PROCEDURE [dbo].[P_GRUD_CrearProveedor]
...
CREATE PROCEDURE [dbo].[P_GetEquiposPorTipo_G]
...
CREATE PROCEDURE [dbo].[P_GRUD_ObtenerProveedores]
...
CREATE PROCEDURE [dbo].[P_GRUD_CrearRadio]
